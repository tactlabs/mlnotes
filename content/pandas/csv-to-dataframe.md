...
```python
csv = pd.DataFrame.read_csv('uk-500.csv')
```
    ...
    /tmp/ipykernel_5582/2603767424.py in <module>
    ----> 1 csv = pd.DataFrame.read_csv('uk-500.csv')
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>593 Kinglake St</td>
      <td>City and Hunslet Ward</td>
      <td>Greater London</td>
      <td>HP4 2AF</td>
      <td>01576-536794</td>
      <td>01370-171283</td>
      <td>deangelo_rardon@yahoo.com</td>
